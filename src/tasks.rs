...
impl TaskStore {
    ...
    pub(crate) fn refresh_if_changed(&mut self) {
    ...
    pub(crate) fn upcoming(&self, now: DateTime<Local>) -> Vec<(&Task, DateTime<Local>)> {
...
impl Recurrence {
    fn next_occurrence(&self, now: DateTime<Local>) -> Option<DateTime<Local>> {
        // Walking dates keeps support for BYDAY, COUNT, and UNTIL correct.
...
pub(crate) fn common_cjk_charset() -> String {
